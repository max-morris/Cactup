# frontera runscript (variant "default"), ported from simfactory2
# mdb/runscripts/frontera.run; .py form of the earlier default.sh.
#
...
time ibrun -n {tasks} {executable} -L 3 {parfile}
