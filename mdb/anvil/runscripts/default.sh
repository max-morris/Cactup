#! /bin/bash
# anvil runscript (variant "default"), ported from simfactory2
# mdb/runscripts/anvil.run.
#
...
# WARNING: using srun can result in incorrect thread bindings even when
# SystemTopology is used (RH, 2025-01-24)
