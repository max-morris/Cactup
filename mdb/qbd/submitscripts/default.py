...
#
# .py variant (design §6.1): PBS #PBS directives require .py, since cactup
# auto-prepends env-setup above the directive header of a .sh submitscript,
# which qsub would then ignore.
#
