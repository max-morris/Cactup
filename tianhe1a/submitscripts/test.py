# tianhe1a TEST submitscript (variant "test") — marked test = true in
...
# env-setup is NOT auto-prepended for .py variants (design §6.1); empty for
# this machine (no [environment]).
