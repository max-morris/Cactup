"""Machine discovery for hal1 (Raspberry Pi at LSU CCT).

Replaces simfactory's `aliaspattern = ^hal1.cct.lsu.edu$` (regex verbatim,
including the unescaped dots).
"""
import re

_PATTERN = re.compile(r"^hal1.cct.lsu.edu$")
