# db1.hpc.lsu.edu submitscript (variant "default"), ported from simfactory2
# mdb/submitscripts/db-new.sub (upstream's native rewrite).
#
...
# The GPU directive (--gpus-per-task 1) is kept verbatim.
