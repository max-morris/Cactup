# supermucng submitscript (variant "default"), ported from simfactory2
# mdb/submitscripts/supermucng.sub.
#
...
# Kept verbatim: -D ./, --export=NONE, --get-user-env (the machine `submit`
# command re-adds --export=ALL on the sbatch call itself).
